myApp
    .controller('replacementClaimAnalysisReportController', ['$scope', '$q', 'applicationBasePath', 'userService',
        'locationCommonService', 'supplierCommonService', 'currencyCommonService', 'productGroupCommonService',
        'productSubGroupCommonService', 'productCategoryCommonService', 'productBrandCommonService', 'productModelCommonService',
        'productCommonService', 'supplierCommonService', 'supplierGroupCommonService','replacementClaimAnalysisReportNameCommonService',
        function (
            ...
            $scope.PrintReport = function () {
                var url = applicationBasePath + "/Inventory360Reports/PrintReplacementClaimAnalysis?reportName=" + $scope.reportName
            ...
            var GetReportNameForDrowdown = function () {
                replacementClaimAnalysisReportNameCommonService.FetchClaimAnalysisReportName().then(function (value) {
